...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.82.01), Wed Aug 10 16:04:52 2016
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/Ian/git/Open Source IRAP/Open Source IRAP.psyexp',
...
# Generate unshuffled lists of the stimuli exemplars for output
labelA_stimuli_for_output = generate_trials('labelA_stimuli', 2, False)  # function and variable determined at begin exp.
labelB_stimuli_for_output = generate_trials('labelB_stimuli', 2, False)
targetA_stimuli_for_output = generate_trials('targetA_stimuli', 2, False)
targetB_stimuli_for_output = generate_trials('targetB_stimuli', 2, False)
labelA_image_stimuli_for_output = generate_trials('labelA_image_stimuli', 2, False)
labelB_image_stimuli_for_output = generate_trials('labelB_image_stimuli', 2, False)
targetA_image_stimuli_for_output = generate_trials('targetA_image_stimuli', 2, False)
targetB_image_stimuli_for_output = generate_trials('targetB_image_stimuli', 2, False)
...
task = data.TrialHandler(nReps=1, method='sequential', 
    extraInfo=expInfo, originPath=u'/Users/Ian/git/Open Source IRAP/Open Source IRAP.psyexp',
